...
[中国计算机学会推荐国际学术会议和期刊目录-2019](https://www.ccf.org.cn/Academic_Evaluation/By_category/)

[下载目录](https://www.ccf.org.cn/ccf/contentcore/resource/download?ID=99202)
...
序号 | 刊物名称 | 类型 | 刊物全称 | 出版社
:-: | :-: | :-: | :-: | :-:
1 | AI | 人工智能-综合 | [Artificial Intelligence](http://dblp.uni-trier.de/db/journals/ai/) | Elsevier
2 | TPAMI | 机器智能-综合 | [IEEE Trans on Pattern Analysis and Machine Intelligence](http://dblp.uni-trier.de/db/journals/pami/) | IEEE
3 | IJCV | 计算机视觉 | [International Journal of Computer Vision](http://dblp.uni-trier.de/db/journals/ijcv/) | Springer
4 | JMLR | 机器学习-综合 | [Journal of Machine Learning Research](http://dblp.uni-trier.de/db/journals/jmlr/) | MIT Press
...
2 | TSLP | 语音语言 | [ACM Transactions on Speech and Language Processing](http://dblp.uni-trier.de/db/journals/tslp/) | ACM
3 | AAMAS |  | [Autonomous Agents and Multi-Agent Systems](http://dblp.uni-trier.de/db/journals/aamas/) | Springer
4 | | 计算语言学 | [Computational Linguistics](http://dblp.uni-trier.de/db/journals/coling/) | MIT Press
5 | CVIU | 视觉图像 | [Computer Vision and Image Understanding](http://dblp.uni-trier.de/db/journals/cviu/) | Elsevier
...
序号 | 刊物名称 | 类型 | 刊物全称 | 出版社
:-: | :-: | :-: | :-: | :-:
1 | AAAI | 人工智能-综合 | [AAAI Conference on Artificial Intelligence](http://dblp.uni-trier.de/db/conf/aaai/) | AAAI
2 | NeurIPS | 神经信息处理 | [Annual Conference on Neural Information Processing Systems](http://dblp.uni-trier.de/db/conf/nips/) | MIT Press
3 | ACL | 计算语言学 | [Annual Meeting of the Association for Computational Linguistics](http://dblp.uni-trier.de/db/conf/acl/) | ACL
4 | CVPR | 视觉&模式识别 | [IEEE Conference on Computer Vision and Pattern Recognition](http://dblp.uni-trier.de/db/conf/cvpr/) | IEEE
5 | ICCV | 计算机视觉 | [International Conference on Computer Vision](http://dblp.uni-trier.de/db/conf/iccv/) | IEEE
6 | ICML | 机器学习-综合 | [International Conference on Machine Learning](http://dblp.uni-trier.de/db/conf/icml/) | ACM
7 | IJCAI | 人工智能-综合 | [International Joint Conference on Artificial Intelligence](http://dblp.uni-trier.de/db/conf/ijcai/) | Morgan Kaufmann

### CCF-B 类会议

序号 | 刊物名称 | 类型 | 刊物全称 | 出版社
:-: | :-: | :-: | :-: | :-:
1 | COLT | 计算学习理论 | [Annual Conference on Computational Learning Theory](http://dblp.uni-trier.de/db/conf/colt/) | Springer
2 | EMNLP | 自然语言处理 | [Conference on Empirical Methods in Natural Language Processing](http://dblp.uni-trier.de/db/conf/emnlp/) | ACL
3 | ECAI | 人工智能-综合 | [European Conference on Artificial Intelligence](http://dblp.uni-trier.de/db/conf/ecai/) | IOS Press
4 | ECCV | 计算机视觉 | [European Conference on Computer Vision](http://dblp.uni-trier.de/db/conf/eccv/) | Springer
5 | ICRA | 机器人&自动化 | [IEEE International Conference on Robotics and Automation](http://dblp.uni-trier.de/db/conf/icra/) | IEEE
...
8 | COLING | 计算语言学 | [International Conference on Computational Linguistics](http://dblp.uni-trier.de/db/conf/coling/) | ACM
9 | KR | 知识表示与推理 | [International Conference on Principles of Knowledge Representation and Reasoning](http://dblp.uni-trier.de/db/conf/kr/) | Morgan Kaufmann
10 | UAI | 人工智能的不确定性 | [International Conference on Uncertainty in Artificial Intelligence](http://dblp.uni-trier.de/db/conf/uai/) | AUAI
...
- 中国相关组织机构
	...
	- 中国人工智能学会（[CAAI](http://www.caai.cn/)）
	- 中国中文信息学会（[CIPSC](http://www.cipsc.org.cn/)）
	- 中国中文信息学会[理事会](http://www.cipsc.org.cn/lingdao.php)
- 中国 NLP 相关会议
	- 自然语言处理与中文计算会议 [NLPCC](http://tcci.ccf.org.cn/nlpcc.php) （International Conference on Natural Language Processing and Chinese Computing）
	- 全国计算语言学大会 CCL（China National Conference on ComputationalLinguistics）
	- 全国青年计算语言学会议 YCCL
	- 全国知识图谱与语义计算大会 CCKS
	- 全国社会媒体处理大会 SMP
	- 全国信息检索学术会议 CCIR（China Conference on Information Retrieval）
	- 全国机器翻译研讨会 CWMT（China Workshop on Machine Translation）
